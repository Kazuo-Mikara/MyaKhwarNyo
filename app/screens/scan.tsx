...
const Scan = () => {
  ...
  // Added state to manage network request loading UI
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Loading Overlay spinner when processing server request */}
      {isProcessing && (
        <View style={styles.loadingOverlay}>
          <ActivityIndicator size="large" color="#4CFF91" />
          <Text style={styles.loadingOverlayText}>Analyzing Plant Patterns...</Text>
        </View>
      )}
      ...
      <View style={styles.instructionContainer}>
        <Text style={styles.instructionText}>
          {isProcessing ? "Processing Server Analysis..." : "Align the plant in the frame, then tap the shutter."}
        </Text>
      </View>

      {/* Bottom controls */}
      <View style={styles.bottomControls}>
        <Pressable style={styles.sideButton} disabled={isProcessing}>
        ...
        <Pressable style={styles.sideButton} onPress={handleToggleCamera} disabled={isProcessing}>
...
// Appended loading styles directly underneath your baseline stylesheet rules
const styles = StyleSheet.create({
  ...
  loadingOverlay: {
    ...
    backgroundColor: "rgba(2,19,11,0.75)",
    justifyContent: "center",
    alignItems: "center",
    zIndex: 20,
  },
